...
class Agent(object):
    def __init__(self, alpha, beta, tau, env, n_actions,gamma=0.99,
        ...
        self.gamma = gamma
        self.tau = tau
        self.memory = ReplayBuffer(max_size,  self.input_size, n_actions)
        self.batch_size = batch_size

        self.actor = ActorNetwork(alpha,  self.input_size, layer1_size,
                                  layer2_size, n_actions=n_actions,
                                  name='Actor')
        self.critic = CriticNetwork(beta,  self.input_size, layer1_size,
                                    layer2_size, n_actions=n_actions,
                                    name='Critic')

        self.target_actor = ActorNetwork(alpha,  self.input_size, layer1_size,
                                         layer2_size, n_actions=n_actions,
                                         name='TargetActor')
        self.target_critic = CriticNetwork(beta,  self.input_size, layer1_size,
                                           layer2_size, n_actions=n_actions,
                                           name='TargetCritic')
