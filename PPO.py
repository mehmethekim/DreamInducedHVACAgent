...
class CriticNetwork(nn.Module):
    ...
    def load_checkpoint(self):
        self.load_state_dict(T.load(self.checkpoint_file))
class Agent:
    def __init__(self, env, n_actions, gamma=0.99, alpha=0.0003, gae_lambda=0.95,
        ...
        self.actor = ActorNetwork(n_actions, self.input_size, alpha)
        self.critic = CriticNetwork(self.input_size, alpha)
    ...
    def choose_action(self, observation: List[Any])-> Sequence[Any]:
        ...
        return tuple(action), probs, value
